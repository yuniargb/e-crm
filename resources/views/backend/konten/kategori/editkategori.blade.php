...
<div class="col-md-8">
    <div class="card">
        ...
        <div class="card-block">
            <form action="/kategori/update/{{ $ktg->id }}" method="post">
                @csrf
                {{ method_field('PUT') }}
                <div class="form-group row">
                    <label for="namakategori" class="col-xs-2 col-form-label form-control-label">Name</label>
                    <div class="col-sm-10">
                        <input class="form-control {{ $errors->has('nama_kategori') ? 'input-danger' : '' }}" type="text" id="namakategori" name="nama_kategori" value="{{ $ktg->nama_kategori }}">
